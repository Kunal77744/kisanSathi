...
export default function SchemesError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error("Schemes Route Error:", error);
  }, [error]);
      ...
      <div className="max-w-2xl w-full text-center space-y-8 p-10 rounded-3xl bg-white dark:bg-stone-900 border border-kisan-cream-200 dark:border-kisan-green-900/30 shadow-xl">
        ...
        <div className="space-y-3">
          <h1 className="text-3xl font-extrabold text-stone-900 dark:text-white">
            योजनाएं लोड नहीं हो सकीं (Error Loading Schemes)
          </h1>
          <p className="text-base text-stone-600 dark:text-stone-400">
            सरकारी योजनाओं की जानकारी लोड करने में समस्या आई है। कृपया दोबारा प्रयास करें।
          </p>
        </div>
